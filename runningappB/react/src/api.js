...
export const restoreRun = (id) => API.put(`/runs/${id}/restore`);
export const getRunById = (id) => API.get(`/runs/${id}`);
export const getDeletedRuns = (userId) => API.get(`/runs/deleted/${userId}`);
...
export const getDeletedGoals = (userId) => API.get(`/goals/deleted/${userId}`);